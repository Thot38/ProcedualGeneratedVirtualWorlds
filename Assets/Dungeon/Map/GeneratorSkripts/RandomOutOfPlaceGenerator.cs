...
public class RandomOutOfPlaceGenerator : IGenerator
{
    ...
    public RandomOutOfPlaceGenerator(float landMasses, int numberOfAdjacents, int variance, int numberOfSmoothings, string seed)
    {
    ...
    public void Fill(ref float[,,] map, int width, int height, int depth)
    {
        ...
        {
           map = Smooth(ref map, width, height, depth);
        }
    }

    private float[,,] Smooth(ref float[,,] map, int width, int height, int depth)
    {
